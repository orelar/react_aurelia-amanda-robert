    ...
    <>
      <div className="container">
        ...
        <div className="d-flex gap-4 justify-content-center mb-4">
          <button className="btn btn-info p-2 text-white" onClick={() => { console.log(Math.floor(Math.random() * 100)); }}>Number Generator</button>
          <button className="btn btn-info p-2 text-white" onClick={handleChangeLanguage}>Change Language</button>
        </div>
      </div>
    </>
  )
